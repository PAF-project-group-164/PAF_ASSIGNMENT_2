...
public class paymentAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = paymentobj.insertPayment(request.getParameter("Payment_customer_id"), 
				  request.getParameter("Payment_customer_name"), 
				  request.getParameter("Payment_date"), 
				  request.getParameter("Payment_amount"),
				  request.getParameter("Payment_description"));
